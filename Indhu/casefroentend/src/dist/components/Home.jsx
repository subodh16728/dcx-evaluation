    ...
    return (<div className="row mx-auto  ">
            ...
            <div className="search-container d-flex justify-content-between  " style={{ marginTop: '20px' }}>
                <div className="search">
                    <input type="text" placeholder="Search by product name..." value={searchTerm} onChange={handleSearch}/> <i className="bi bi-search"></i>
                </div>
                    ...
                    <tbody>
                        ...
                        <react_router_dom_1.NavLink to={`/productDetails/${product._id}`}>
                          {product.name}
                                ...
                                <td> <react_router_dom_1.NavLink to={""} className='w-pbuton' onClick={() => { handleremoveproduct(product._id); }}><i className="bi bi-trash3"></i></react_router_dom_1.NavLink>
